# Kaguya i18n
This directory contains the translations for Kaguya browser UI strings.
...
- "Kaguya" and other brand names should not be translated
...
## Development
When adding strings to Kaguya, you might need to regenerate the source
