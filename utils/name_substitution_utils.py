...
REPLACEMENT_REGEXES_STR = [
    ...
    # main replacement(s)
    (r'(\b)chrome://', r'\1openium://'),
    (r'(?:Google )?Chrom(e|ium)(?!\w)', r'Openium'),
...
def replace_text(text):
    """Replaces instances of Chrom(e | ium) with Openium in strings"""
    had_match = False
...
def replace_grit_message(msg):
    """
    Replaces instances of Chrom(e | ium) with Openium
...
def replace_xtb_translation(msg, fp_map):
    """
    Replaces instances of Chrom(e | ium) with Openium in a
    .xtb <translation>.
    """
...
def replace_grit_tree(text):
    """Replaces instances of Chrom(e | ium) with Openium, where desired"""
...
def dedup_translations_in_place(translation, seen):
    ...
    # "Chrome" variant. Since we substituted both of those with Openium,
